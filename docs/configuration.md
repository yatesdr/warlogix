...
In normal use the config file will not need to be edited by hand, but for automation and use with Ansible or other deployments it is useful to document the format.  
