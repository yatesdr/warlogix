...
The REST API exposes PLC data over HTTP for integration with other systems and debugging.   This can be useful if the other systems reside on a routable subnet and need a simple polling check, but the other publishing options are much more performant and should be preferred.
